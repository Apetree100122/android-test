...
# Fail on any error.
set -e  # this directory must exist for artifacts to be uploaded
...
bazelisk build:axt_ 
m2repository # copy the zip here so that we don't follow symlinks to get the files to upload
